...
class _CreateUserWidgetState extends State<CreateUserWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<VaquerosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VaquerosRecord> createUserVaquerosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createUserVaquerosRecord = createUserVaquerosRecordList.isNotEmpty
            ? createUserVaquerosRecordList.first
            : null;
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(50.0, 25.0, 50.0, 0.0),
                    child: Text(
                      'Ingrese la informacion que se solicita para poder registrar un vaquero nuevo en la finca.',
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await VaquerosRecord.collection
                            .doc()
                            .set(createVaquerosRecordData(
                        ...
                        await showDialog(
                          ...
                          builder: (alertDialogContext) {
                            return AlertDialog(
                              title: Text('Vaquero guardado...'),
                              content: Text('El vaquero se guardo con exito'),
                              actions: [
                                TextButton(
                                  onPressed: () =>
