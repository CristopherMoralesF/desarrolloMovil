...
import 'registro_venta_model.dart';
export 'registro_venta_model.dart';

class RegistroVentaWidget extends StatefulWidget {
  const RegistroVentaWidget({Key? key}) : super(key: key);

  @override
  _RegistroVentaWidgetState createState() => _RegistroVentaWidgetState();
}

class _RegistroVentaWidgetState extends State<RegistroVentaWidget> {
  late RegistroVentaModel _model;
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.txtIdVentaController,
                        focusNode: _model.txtIdVentaFocusNode,
                        autofocus: true,
                        obscureText: false,
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(50.0, 25.0, 50.0, 0.0),
                      child: TextFormField(
                        controller: _model.txtCantidadVentaController,
                        focusNode: _model.txtCantidadVentaFocusNode,
                        autofocus: true,
                        obscureText: false,
                        decoration: InputDecoration(
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await RegistroVentaRecord.collection
                              .doc()
                              .set(createRegistroVentaRecordData(
                                identificadorVenta:
