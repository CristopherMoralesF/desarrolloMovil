                  ...
                  child: Stack(
                    children: [
                      Padding(
                        ...
                        child: PageView(
                          controller: _model.dataCardsController ??=
                        ...
                        child: Padding(
                          ...
                          child: smooth_page_indicator.SmoothPageIndicator(
                            ...
                            onDotClicked: (i) async {
                              await _model.dataCardsController!.animateToPage(
                                i,
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('ingresarVaca');
                                    },
                                    text: 'Ingresar Vaca',
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context
                                          .pushNamed('homeAdministrarLecheria');
                                    },
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context
                                          .pushNamed('homeAppAdministration');
                                    },
                                    text: 'Administrar Lechería',
                                    options: FFButtonOptions(
                                      height: 40.0,
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          24.0, 0.0, 24.0, 0.0),
