...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ingresarVaca',
          path: '/ingresarVaca',
          builder: (context, params) => IngresarVacaWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => EditarEnfermedadWidget(),
        ),
        FFRoute(
          name: 'Template',
          path: '/template',
        ...
        FFRoute(
          name: 'homeAdministrarLecheria',
          path: '/homeAdministrarLecheria',
          builder: (context, params) => HomeAdministrarLecheriaWidget(
            cantidadLecheVendida:
                params.getParam('cantidadLecheVendida', ParamType.double),
          ),
        ),
        FFRoute(
          name: 'ingresoLeche',
          path: '/ingresoLeche',
          builder: (context, params) => IngresoLecheWidget(),
        ),
        FFRoute(
          name: 'registroVenta',
          path: '/registroVenta',
          builder: (context, params) => RegistroVentaWidget(),
        ),
        FFRoute(
          name: 'homeAppAdministration',
          path: '/homeAppAdministration',
          builder: (context, params) => HomeAppAdministrationWidget(),
        ),
        FFRoute(
          name: 'createUser',
          path: '/createUser',
        ...
        FFRoute(
          ...
          builder: (context, params) => AdministrarUsuariosWidget(),
        ),
        FFRoute(
